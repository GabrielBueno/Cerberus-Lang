...
EXPR_SRC   = ./src/parser/expr/expr.cpp ./src/parser/expr/binary_expr.cpp  ./src/parser/expr/grouping_expr.cpp ./src/parser/expr/literal_expr.cpp ./src/parser/expr/unary_expr.cpp 
